...
/**
 * TurbineStatusCode_2008
 *
 * @ORM\Table(name="`DATA_WAREHOUSE.TurbineStatusCode_2008`")
 * @ORM\Entity(repositoryClass="Base\CoreBundle\Repository\TurbineStatusCode_2008Repository")
 */
class TurbineStatusCode_2008
{
    /**
