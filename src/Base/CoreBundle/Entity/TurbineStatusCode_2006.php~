...
/**
 * TurbineStatusCode_2006
 * @ORM\Table(name="`DATA_WAREHOUSE.TurbineStatusCode_2006`")
 * @ORM\Entity(repositoryClass="Base\CoreBundle\Repository\TurbineStatusCode_2006Repository")
 */
class TurbineStatusCode_2006
{
    /**
