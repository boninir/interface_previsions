...
/**
 * TurbineStatusCode_2010
 *
 * @ORM\Table(name="`DATA_WAREHOUSE.TurbineStatusCode_2010`")
 * @ORM\Entity(repositoryClass="Base\CoreBundle\Repository\TurbineStatusCode_2010Repository")
 */
class TurbineStatusCode_2010
{
    /**
