...
/**
 * TurbineStatusCode_2005
 *
 * @ORM\Table(name="`DATA_WAREHOUSE.TurbineStatusCode_2005`")
 * @ORM\Entity(repositoryClass="Base\CoreBundle\Repository\TurbineStatusCode_2005Repository")
 */
class TurbineStatusCode_2005
{
    /**
