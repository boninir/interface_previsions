...
/**
 * TurbineStatusCode_2012
 *
 * @ORM\Table(name="`DATA_WAREHOUSE.TurbineStatusCode_2012`")
 * @ORM\Entity(repositoryClass="Base\CoreBundle\Repository\TurbineStatusCode_2012Repository")
 */
class TurbineStatusCode_2012
{
    /**
