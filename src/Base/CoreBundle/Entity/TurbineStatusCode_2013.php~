...
/**
 * TurbineStatusCode_2013
 *
 * @ORM\Table(name="`DATA_WAREHOUSE.TurbineStatusCode_2013`")
 * @ORM\Entity(repositoryClass="Base\CoreBundle\Repository\TurbineStatusCode_2013Repository")
 */
class TurbineStatusCode_2013
{
    /**
