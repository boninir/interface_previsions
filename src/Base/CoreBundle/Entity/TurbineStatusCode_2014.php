...
/**
 * TurbineStatusCode_2014
 *
 * @ORM\Table(name="`DATA_WAREHOUSE.TurbineStatusCode_2014`")
 * @ORM\Entity(repositoryClass="Base\CoreBundle\Repository\TurbineStatusCode_2014Repository")
 */
class TurbineStatusCode_2014
{
    /**
