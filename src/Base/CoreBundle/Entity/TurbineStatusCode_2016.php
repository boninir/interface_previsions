...
/**
 * TurbineStatusCode_2016
 *
 * @ORM\Table(name="`DATA_WAREHOUSE.TurbineStatusCode_2016`")
 * @ORM\Entity(repositoryClass="Base\CoreBundle\Repository\TurbineStatusCode_2016Repository")
 */
class TurbineStatusCode_2016
{
    /**
