...
/**
 * TurbineStatusCode_2009
 *
 * @ORM\Table(name="`DATA_WAREHOUSE.TurbineStatusCode_2009`")
 * @ORM\Entity(repositoryClass="Base\CoreBundle\Repository\TurbineStatusCode_2009Repository")
 */
class TurbineStatusCode_2009
{
    /**
