...
/**
 * TurbineStatusCode_2007
 *
 * @ORM\Table(name="`DATA_WAREHOUSE.TurbineStatusCode_2007`")
 * @ORM\Entity(repositoryClass="Base\CoreBundle\Repository\TurbineStatusCode_2007Repository")
 */
class TurbineStatusCode_2007
{
    /**
